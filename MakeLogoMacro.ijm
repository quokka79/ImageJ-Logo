...
my_radius = 1.0 * base_unit;
offset_x = -0.55 * base_unit;
offset_y = 0.55 * base_unit;
my_x = offset_x + x_origin - my_radius/2; // top left corner
my_y = offset_y + y_origin - my_radius/2; 
makeOval(my_x, my_y, my_radius, my_radius);
roiManager("Add");
...
my_x = offset_x + x_origin - (my_width/2);
my_y = offset_y + y_origin - (my_height/2);
makeRectangle(my_x, my_y, my_width, my_height);
roiManager("Add");
